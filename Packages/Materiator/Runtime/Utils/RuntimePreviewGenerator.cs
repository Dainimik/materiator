...
namespace Materiator
{
	...
	private static Material boundsMaterial;
        ...
        /// <summary>
        /// (default: null) lets you use your own camera for rendering the thumbnails instead of an internal camera that is automatically generated by RuntimePreviewGenerator.
        /// This is useful when you want to render thumbnails with some post-processing effects applied. You can set it to null to continue using the internal camera.
        /// </summary>
        ...
        /// <summary>
        /// (default: Vector3(-1,-1,-1)) the direction that the camera will face relative to the previewed object's forward axis.
        /// So, a value of Vector3(0,0,-1) will create thumbnails from directly in front of the previewed object whereas a value of Vector3(0,0,1) will create thumbnails from behind the previewed object.
        /// </summary>
        ...
        /// <summary>
        /// (default: 0) additional % padding applied to the edges of the thumbnail texture. The accepted value range is (-0.25,0.25). Enter a negative value if there is too much space at the edges of the thumbnails by default.
        /// </summary>
        ...
        /// <summary>
        /// (default: Color(0.3,0.3,0.3,1)) background color of the thumbnail texture. If alpha value is less than 1, generated textures will be semi-transparent (or completely transparent, if alpha=0).
        /// Note that transparent textures consume more memory than opaque textures.
        /// </summary>
        ...
        /// <summary>
        /// (default: false) determines whether orthographic projection (true) or perspective projection (false) will be used while rendering the thumbnails.
        /// Thumbnails rendered with orthographic projection usually fill more pixels and are more center-aligned when compared to perspective projection.
        /// </summary>
        ...
        /// <summary>
        /// (default: true) marks the generated texture as non-readable for better memory usage. If you plan to modify the texture later (e.g. GetPixels/SetPixels), set its value to false.
        /// </summary>
